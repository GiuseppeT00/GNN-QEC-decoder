...
#SBATCH -J d7_d_t_1_rep
#SBATCH -o ./job_outputs/d7_d_t_1_rep_id%j.out
...
#SBATCH --mem=156G
#SBATCH --dependency=afterok:2033143
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d7_d_t_1_rep_epoch500'
