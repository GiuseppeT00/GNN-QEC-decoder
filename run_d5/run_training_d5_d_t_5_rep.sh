...
#SBATCH -J d5_d_t_5_rep
#SBATCH -o ./job_outputs/d5_d_t_5_rep_id%j.out
...
#SBATCH --mem=92G
#SBATCH --dependency=afterok:2028187
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_5_rep_epoch500'
