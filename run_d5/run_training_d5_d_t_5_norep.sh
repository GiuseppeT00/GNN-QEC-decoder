...
#SBATCH -J d5_d_t_5_norep
#SBATCH -o ./job_outputs/d5_d_t_5_norep_id%j.out
...
#SBATCH --mem=92G
#SBATCH --dependency=afterok:2026015

# Set and export parameters
export CODE_SIZE=5
export REPETITIONS=5
## Training settings
export NUM_ITERATIONS=150
...
export REPLACEMENTS_PER_ITERATION=0 #250 o 25 ; (1) 2 ;
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_5_norep_epoch150'
