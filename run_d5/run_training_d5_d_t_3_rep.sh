...
#SBATCH -J d5_d_t_3_rep
#SBATCH -o ./job_outputs/d5_d_t_3_rep_id%j.out
...
#SBATCH --mem=56G
#SBATCH --dependency=afterok:2028185
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_3_rep_epoch500'
