...
#SBATCH -J d5_d_t_7_rep
#SBATCH -o ./job_outputs/d5_d_t_7_rep_id%j.out
...
#SBATCH --mem=128G
#SBATCH --dependency=afterok:2031399
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_7_rep_epoch500'
