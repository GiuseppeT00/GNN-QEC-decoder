...
#SBATCH -J d5_d_t_9_rep
#SBATCH -o ./job_outputs/d5_d_t_9_rep_id%j.out
...
#SBATCH --mem=168G
#SBATCH --dependency=afterok:2033142
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_9_rep_epoch480'
