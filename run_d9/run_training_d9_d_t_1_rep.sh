...
#SBATCH -J d9_d_t_1_rep
#SBATCH -o ./job_outputs/d9_d_t_1_rep_id%j.out
...
#SBATCH --mem=180G
#SBATCH --dependency=afterok:2033124

# Set and export parameters
export CODE_SIZE=9
export REPETITIONS=1
## Training settings
export NUM_ITERATIONS=90
...
## Load old model:
export RESUMED_TRAINING_FILE_NAME='d5_d_t_3_rep_epoch90'
